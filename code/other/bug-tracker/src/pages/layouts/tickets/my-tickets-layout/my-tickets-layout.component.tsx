...
import { TMyTicketsLayoutProps } from "./my-tickets-layout.definition";
...
export function MyTicketsLayout({ className }: TMyTicketsLayoutProps) {
   return (
      <S.TicketsLayoutDiv className={className}>
         ...
         {/* this is were the ticket map will go */}
